...
namespace Inheritance
{
    class Animal
    {
        ...
        // Inheritance has a "is-a" relationship, while an aggregation or delegate
        ...
        // Must add override to the method in the subclass
        public virtual void MakeSound() => Console.WriteLine($"{Name} says {Sound}");
        ...
        // Can create inner classes that are normally helper classes for the outer
