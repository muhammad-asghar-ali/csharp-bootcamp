...
namespace Methods
{
    ...
    public class Program
    {
        ...
        {
            // Like we did with predicates earlier Lambda expressions allow you to use anonymous methods that define
            ...
            // You don't have to use delegates though Here we'll search through a list to 
            ...
            // -------------------------------------------- ZIP --------------------------------------------
            // Zip applies a function to two lists. Add values in 2 lists together
            ...
            foreach (var n in sumList) Console.WriteLine(n);
