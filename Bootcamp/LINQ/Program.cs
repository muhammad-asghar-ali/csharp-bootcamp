...
namespace LINQ
{
    public class Program
    {
        ...
        // Manipulate data using Query Expressions
        ...
        static void QueryCollection()
        {
            ...
            {
                new() {Name = "German Shepherd", Height = 25, Weight = 77},
                new() {Name = "Chihuahua",Height = 7, Weight = 4.4},
                new() {Name = "Saint Bernard",Height = 30, Weight = 200}
            };
