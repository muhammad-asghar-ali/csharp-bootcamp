...
namespace Advance
{
    public class Box
    {
        ...
        // Through operator overloading you can allow users to interact with your
        // custom objects in interesting ways You can overload +, -, *, /, %, !,
        // ==, !=, >, <, >=, <=, ++ and --
        public static Box operator -(Box box1, Box box2)
        {
            Box newBox = new Box()
        ...
        // Define how your object is converted into a string by overridding ToString
        public override string ToString()
        {
            return String.Format("Box with Height : {0} Width : {1} and Breadth : {2}", Length, Width, Breadth);
        }

        // Can convert from a Box into an int like this even though this wouldn't make sense
